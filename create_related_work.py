...
def student_option_in_class(school_name,class_name):
    ...
    try:
        ...
        print('\nYou have entered alphabet which is wrong input.Please do it again with the right input.')
        # call choices function
        # school_choices()
    except:
        print('\nThere is a problem in the input.Please do it again with the right input.')
        # call choices function
        # school_choices()
    else:
        if option == 1:
